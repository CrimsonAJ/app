...
.method public static a(Landroid/media/session/PlaybackState;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 5
    .line 6
    invoke-static {v0}, Landroid/support/v4/media/session/z;->j(Landroid/media/session/PlaybackState;)Ljava/util/List;
    ...
    .line 38
    .line 39
    invoke-static {v4}, Landroid/support/v4/media/session/z;->l(Landroid/media/session/PlaybackState$CustomAction;)Landroid/os/Bundle;
    ...
    .line 43
    invoke-static {v5}, Landroid/support/v4/media/session/y;->E(Landroid/os/Bundle;)V
    ...
    .line 47
    .line 48
    invoke-static {v4}, Landroid/support/v4/media/session/z;->f(Landroid/media/session/PlaybackState$CustomAction;)Ljava/lang/String;
    ...
    .line 52
    invoke-static {v4}, Landroid/support/v4/media/session/z;->o(Landroid/media/session/PlaybackState$CustomAction;)Ljava/lang/CharSequence;
    ...
    .line 56
    invoke-static {v4}, Landroid/support/v4/media/session/z;->m(Landroid/media/session/PlaybackState$CustomAction;)I
    ...
    .line 76
    :goto_2
    invoke-static {v0}, Landroid/support/v4/media/session/A;->a(Landroid/media/session/PlaybackState;)Landroid/os/Bundle;
    ...
    .line 80
    invoke-static/range {v23 .. v23}, Landroid/support/v4/media/session/y;->E(Landroid/os/Bundle;)V
    ...
    .line 84
    .line 85
    invoke-static {v0}, Landroid/support/v4/media/session/z;->r(Landroid/media/session/PlaybackState;)I
    ...
    .line 89
    invoke-static {v0}, Landroid/support/v4/media/session/z;->q(Landroid/media/session/PlaybackState;)J
    ...
    .line 93
    invoke-static {v0}, Landroid/support/v4/media/session/z;->i(Landroid/media/session/PlaybackState;)J
    ...
    .line 97
    invoke-static {v0}, Landroid/support/v4/media/session/z;->p(Landroid/media/session/PlaybackState;)F
    ...
    .line 101
    invoke-static {v0}, Landroid/support/v4/media/session/z;->g(Landroid/media/session/PlaybackState;)J
    ...
    .line 105
    invoke-static {v0}, Landroid/support/v4/media/session/z;->k(Landroid/media/session/PlaybackState;)Ljava/lang/CharSequence;
    ...
    .line 109
    invoke-static {v0}, Landroid/support/v4/media/session/z;->n(Landroid/media/session/PlaybackState;)J
    ...
    .line 113
    invoke-static {v0}, Landroid/support/v4/media/session/z;->h(Landroid/media/session/PlaybackState;)J
    ...
    .line 121
    .line 122
    iput-object v0, v7, Landroid/support/v4/media/session/PlaybackStateCompat;->l:Landroid/media/session/PlaybackState;
...
.method public final toString()Ljava/lang/String;
    ...
    .line 101
    .line 102
    invoke-static {v0, v1, v2, v3}, LA0/a;->o(Ljava/lang/StringBuilder;JLjava/lang/String;)Ljava/lang/String;
