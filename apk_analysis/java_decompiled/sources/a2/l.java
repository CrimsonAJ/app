...
public abstract class l<B extends W.g, V extends r> extends M1.g<B, V> implements InterfaceC2180b {

    /* renamed from: N0, reason: collision with root package name */
    public ContextWrapper f9103N0;

    /* renamed from: O0, reason: collision with root package name */
    public boolean f9104O0;

    /* renamed from: P0, reason: collision with root package name */
    public volatile C2118f f9105P0;

    /* renamed from: Q0, reason: collision with root package name */
    public final Object f9106Q0 = new Object();

    /* renamed from: R0, reason: collision with root package name */
    public boolean f9107R0 = false;

    @Override // i0.AbstractComponentCallbacksC1366v
    public final void D(Activity activity) {
        boolean z9;
        this.f18382D = true;
        ContextWrapper contextWrapper = this.f9103N0;
    ...
    public final Object e() {
        if (this.f9105P0 == null) {
            synchronized (this.f9106Q0) {
                try {
                    if (this.f9105P0 == null) {
                        this.f9105P0 = new C2118f(this);
                    }
                } finally {
                }
            }
        }
        return this.f9105P0.e();
    }
    ...
    public final void s0() {
        if (this.f9103N0 == null) {
            this.f9103N0 = new C2120h(super.m(), this);
            this.f9104O0 = AbstractC0485a.t(super.m());
        }
    }
}
