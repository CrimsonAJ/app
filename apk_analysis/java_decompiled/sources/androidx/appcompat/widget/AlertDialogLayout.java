        ...
        if (mode2 != 1073741824) {
            ...
            while (i21 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c1820s0).width == -1) {
                        int i22 = ((LinearLayout.LayoutParams) c1820s0).height;
                        ((LinearLayout.LayoutParams) c1820s0).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, makeMeasureSpec2, 0, i20, 0);
                        ((LinearLayout.LayoutParams) c1820s0).height = i22;
                    }
                }
                i21++;
