...
public class AppCompatImageView extends ImageView {
    ...
    public final boolean hasOverlappingRendering() {
        if (!(((ImageView) this.f9444b.f47c).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        E e8 = this.f9444b;
        if (e8 != null && drawable != null && !this.f9445c) {
