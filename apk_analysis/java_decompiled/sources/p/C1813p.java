...
public class C1813p extends AutoCompleteTextView implements S.l {

    /* renamed from: d, reason: collision with root package name */
    public static final int[] f22051d = {R.attr.popupBackground};

    /* renamed from: a, reason: collision with root package name */
    public final C0096b f22052a;

    /* renamed from: b, reason: collision with root package name */
    public final C1769T f22053b;

    /* renamed from: c, reason: collision with root package name */
    public final C1831y f22054c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1813p(Context context, AttributeSet attributeSet) {
        ...
        G1 w7 = G1.w(getContext(), attributeSet, f22051d, co.notix.R.attr.autoCompleteTextViewStyle);
    ...
    public final void drawableStateChanged() {
        ...
        C0096b c0096b = this.f22052a;
        if (c0096b != null) {
            c0096b.a();
        }
        C1769T c1769t = this.f22053b;
        if (c1769t != null) {
            c1769t.b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f22053b.d();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f22053b.e();
    }
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f22054c.c(onCreateInputConnection, editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f22054c.a(keyListener));
    }
