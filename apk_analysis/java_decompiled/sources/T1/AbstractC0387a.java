...
public abstract class AbstractC0387a<B extends W.g, V extends M1.r> extends M1.g<B, V> implements InterfaceC2180b {

    /* renamed from: N0, reason: collision with root package name */
    public ContextWrapper f6999N0;

    /* renamed from: O0, reason: collision with root package name */
    public boolean f7000O0;

    /* renamed from: P0, reason: collision with root package name */
    public volatile C2118f f7001P0;

    /* renamed from: Q0, reason: collision with root package name */
    public final Object f7002Q0 = new Object();

    /* renamed from: R0, reason: collision with root package name */
    public boolean f7003R0 = false;

    @Override // i0.AbstractComponentCallbacksC1366v
    public final void D(Activity activity) {
        boolean z9;
        this.f18382D = true;
        ContextWrapper contextWrapper = this.f6999N0;
    ...
    public final Object e() {
        if (this.f7001P0 == null) {
            synchronized (this.f7002Q0) {
                try {
                    if (this.f7001P0 == null) {
                        this.f7001P0 = new C2118f(this);
                    }
                } finally {
                }
            }
        }
        return this.f7001P0.e();
    }
    ...
    public final void s0() {
        if (this.f6999N0 == null) {
            this.f6999N0 = new C2120h(super.m(), this);
            this.f7000O0 = AbstractC0485a.t(super.m());
        }
    }
}
