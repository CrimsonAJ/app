...
public final class um extends kotlin.jvm.internal.i implements O7.l {
    public um(ic icVar) {
        super(1);
    }
    ...
    public final Object invoke(Object value) {
        ...
        kotlin.jvm.internal.d a5 = kotlin.jvm.internal.p.a(pl.class);
        if (a5.equals(kotlin.jvm.internal.p.a(Long.TYPE))) {
            if (value instanceof Integer) {
                ...
                throw new JSONException(o2.a(pl.class, A0.a.q("Expected ", pl.class, ", but ", value, " is not ")));
            }
            value = (pl) Long.valueOf(doubleValue3);
