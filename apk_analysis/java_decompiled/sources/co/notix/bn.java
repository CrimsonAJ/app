...
public final class bn extends kotlin.jvm.internal.i implements O7.l {
    public bn(ic icVar) {
        super(1);
    }
    ...
    public final Object invoke(Object value) {
        ...
        kotlin.jvm.internal.d a5 = kotlin.jvm.internal.p.a(tj.class);
        if (a5.equals(kotlin.jvm.internal.p.a(Long.TYPE))) {
            if (value instanceof Integer) {
                ...
                throw new JSONException(o2.a(tj.class, A0.a.q("Expected ", tj.class, ", but ", value, " is not ")));
            }
            value = (tj) Long.valueOf(doubleValue3);
