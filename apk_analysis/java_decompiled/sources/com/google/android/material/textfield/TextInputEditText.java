...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet) {
        ...
        this.f16167g = new Rect();
        int[] iArr = AbstractC1254a.f17732R;
    ...
    public final void getFocusedRect(Rect rect) {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && this.f16168h && rect != null) {
            Rect rect2 = this.f16167g;
    ...
    public final boolean getGlobalVisibleRect(Rect rect, Point point) {
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && this.f16168h) {
    ...
    public CharSequence getHint() {
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && textInputLayout.f16206f0) {
            return textInputLayout.getHint();
        }
    ...
    public final void onAttachedToWindow() {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && textInputLayout.f16206f0 && super.getHint() == null) {
