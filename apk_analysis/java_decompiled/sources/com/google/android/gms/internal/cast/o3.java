...
public abstract class o3 {
    ...
    public static final Unsafe f14935a;

    /* renamed from: b, reason: collision with root package name */
    public static final Class f14936b;

    /* renamed from: c, reason: collision with root package name */
    public static final n3 f14937c;

    /* renamed from: d, reason: collision with root package name */
    public static final boolean f14938d;

    /* renamed from: e, reason: collision with root package name */
    public static final boolean f14939e;

    /* renamed from: f, reason: collision with root package name */
    public static final long f14940f;

    /* renamed from: g, reason: collision with root package name */
    public static final boolean f14941g;
    ...
    public static void a(Class cls) {
        if (f14939e) {
            f14937c.f14932a.arrayIndexScale(cls);
        }
    }

    public static void b(Object obj, long j, byte b9) {
        Unsafe unsafe = f14937c.f14932a;
        long j4 = (-4) & j;
    ...
    public static int d(long j, Object obj) {
        return f14937c.f14932a.getInt(obj, j);
    }

    public static long e(long j, Object obj) {
        return f14937c.f14932a.getLong(obj, j);
    }

    public static Object f(Class cls) {
        try {
            return f14935a.allocateInstance(cls);
    ...
    public static Object g(long j, Object obj) {
        return f14937c.f14932a.getObject(obj, j);
    }
    ...
    public static int o(Class cls) {
        if (f14939e) {
            return f14937c.f14932a.arrayBaseOffset(cls);
        }
        return -1;
    }
}
