...
public final class C0065k extends G7.j implements O7.p {

    /* renamed from: r, reason: collision with root package name */
    public int f1373r;

    /* renamed from: s, reason: collision with root package name */
    public final /* synthetic */ E f1374s;

    /* renamed from: t, reason: collision with root package name */
    public final /* synthetic */ String f1375t;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0065k(E e8, String str, E7.d dVar) {
        super(2, dVar);
        this.f1374s = e8;
        this.f1375t = str;
    }
    ...
    public final E7.d create(Object obj, E7.d dVar) {
        return new C0065k(this.f1374s, this.f1375t, dVar);
    }

    @Override // O7.p
    public final Object invoke(Object obj, Object obj2) {
        return ((C0065k) create((InterfaceC0484z) obj, (E7.d) obj2)).invokeSuspend(A7.n.f558a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 != 0) {
            ...
            B2.b bVar = e8.f1268a;
            String n7 = AbstractC0953k1.n(O4.h.t(e8.f1269b), g6.o.f17761a.z());
            if (commentConfigResponse != null) {
                i9 = commentConfigResponse.f14021a.f14056a;
            } else {
                i9 = 1;
            }
            DeleteVoteCommentRequest deleteVoteCommentRequest = new DeleteVoteCommentRequest(this.f1375t, i9);
            this.f1373r = 1;
            obj = bVar.E(n7, deleteVoteCommentRequest, this);
            if (obj == aVar) {
                return aVar;
            }
        }
