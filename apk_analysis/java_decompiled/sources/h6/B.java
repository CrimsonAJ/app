...
public final class B extends AbstractC1050v {
    ...
    static {
        B b9 = new B();
        DEFAULT_INSTANCE = b9;
        AbstractC1050v.t(B.class, b9);
    }

    public static C1285A A() {
        return (C1285A) DEFAULT_INSTANCE.h();
    }

    public static B B(AbstractC1037h abstractC1037h, C1043n c1043n) {
        return (B) AbstractC1050v.r(DEFAULT_INSTANCE, abstractC1037h, c1043n);
    }
    ...
    public static void x(B b9, C1036g c1036g) {
        b9.getClass();
        b9.keyValue_ = c1036g;
    }
